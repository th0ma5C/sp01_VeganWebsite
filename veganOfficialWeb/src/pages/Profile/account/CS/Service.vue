    ...
    <div class="chatBox">
        ...
        <main :class="{
            ...
            <div class="msgWrapper" ref="msgWrapperRef">
                ...
                <!-- <div class="otherMsg">
                    <SvgIcon name="ServiceAvatar"
                        height="36px" width="36px"
                        color="#00430b" class="avatarIcon">
                    </SvgIcon>

                    <div class="content">
                        
                ...
                <div class="userMsg">
                    ...
                    <div class="content">
                        時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳時間戳
                    </div>
                </div>
                <div class="otherMsg">
                    <SvgIcon name="ServiceAvatar"
