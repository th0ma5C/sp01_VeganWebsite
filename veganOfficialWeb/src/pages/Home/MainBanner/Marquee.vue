...
let slide = ref()
let n = ref(0)
let totalSlides = swiper.value.length
...
function next() {
    ...
    // console.log(n.value, swiper.value);
    // if (n > 0) {
    //     const shiftItem = swiper.value.shift();
    //     swiper.value.push(shiftItem);
    //     return
    // } else {
    //     const shiftItem = swiper.value.pop();
    //     swiper.value.unshift(shiftItem);
    // }
}
function prev() {
    if (n.value > 0) {
