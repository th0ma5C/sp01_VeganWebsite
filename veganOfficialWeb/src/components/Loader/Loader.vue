    ...
    <transition name="loader">
        <div class="container" :class="{ b: loaded }"
            ...
            <div class="svgContainer">
                ...
                <div class="light" v-show="drawFinished">
                </div>
            </div>
        </div>
    </transition>
...
@for $i from 1 through 13 {
    ...
    .draw-#{$i} {
        animation: 2s ease-out forwards ani-#{$i};
    }
}
